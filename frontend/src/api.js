// Mặc định gọi same-origin (/api) để UI chạy trên cả localhost lẫn IP LAN qua Vite proxy,
// không vướng CORS/cookie SameSite. Chỉ đặt VITE_API_BASE_URL khi backend nằm ở domain khác.
