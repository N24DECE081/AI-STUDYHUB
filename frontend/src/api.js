...
export const demoPayment = ({ plan, billingCycle = 'month' }) => request('/payment/demo', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ plan, billing_cycle: billingCycle, payment_method: 'demo' }) });
