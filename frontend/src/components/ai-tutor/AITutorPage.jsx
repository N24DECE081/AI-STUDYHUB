...
export default function AITutorPage({ selectedDocument }) {
  ...
  const [search, setSearch] = useState(''); const [sending, setSending] = useState(false); const [drawer, setDrawer] = useState(false);
